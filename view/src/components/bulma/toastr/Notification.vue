...
export default {
  ...
  computed: {
    ...
    direction() {
      ...
      return this.toastrPosition.indexOf('right') >= 0 ? 'Right' : 'Left';
    },
    enterClass() {
...
.toastr-wrapper {
  ...
  .toastr.notification {
    ...
    overflow-x: hidden;
    cursor: pointer;
    -webkit-box-shadow: 0 0 5px 3px hsla(0, 0%, 50%, 0.4);
    box-shadow: 0 0 5px 3px hsla(0, 0%, 50%, 0.4);
    ...
    &.highlight {
      -webkit-box-shadow: 0 0 5px 3px hsla(0, 0%, 4%, 0.5);
